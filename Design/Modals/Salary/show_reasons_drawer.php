<!-- drawer component -->
<div id="reason-drawer" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-full  md:w-[500px] dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
    ...
    <button type="button" data-drawer-hide="reason-drawer" aria-controls="reason-drawer" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white">
