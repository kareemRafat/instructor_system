                ...
                <form class="p-4 md:p-5" action="functions/Groups/insert_group.php" method="POST">
                    ...
                    <div class="grid gap-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <!-- Generate button -->
                            <a id="generate-name" href="#" class="inline text-sm font-semibold mt-1 text-blue-700 dark:text-blue-500 ">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="relative w-full mb-2">
                                ...
                                <input autocomplete="off" required name="date" id="datepicker-actions" datepicker datepicker-buttons datepicker-autoselect-today type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="Select date">
                            </div>
                        </div>
