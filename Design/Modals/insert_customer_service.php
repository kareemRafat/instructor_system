        ...
        <div class="relative bg-white rounded-lg shadow-sm">
            ...
            <form class="p-4 md:p-5" action="functions/Customer-service/insert_cs.php" method="POST">
                <div class="grid gap-4 mb-4">
                    ...
                    <div class="col-span-2"> <label for="branch" class="block mb-2 text-sm font-medium text-gray-900">Branch</label>
                    ...
                    <?php if (ROLE === 'admin'): ?>
                        <div class="col-span-2"> <label for="role" class="block mb-2 text-sm font-medium text-gray-900">Role</label>
