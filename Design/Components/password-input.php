<div class="password-wrapper">
    ...
    <input type="password" name="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="<?= !isset($loginPage) ? 'Enter password if you want to Change it ...' : '' ?>">
