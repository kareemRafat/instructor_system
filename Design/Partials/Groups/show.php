...
<div class=" min-h-screen max-w-8xl mx-auto md:px-6 py-6 pb-20">
    ...
    <div class=" flex flex-col-reverse md:flex-row justify-between md:items-center gap-3">
        ...
        <?php $groupPage = isset($_GET['sort']) && $_GET['sort'] == 'asc' ? "groups.php?sort=asc" : "groups.php" ?>
        <a href="<?= isset($_SESSION['page']) ? 'tables.php' : $groupPage ; ?>" class="inline-flex items-center justify-center self-end p-2 text-base font-medium text-gray-500 rounded-lg bg-gray-100 hover:text-gray-900 hover:bg-gray-200">
