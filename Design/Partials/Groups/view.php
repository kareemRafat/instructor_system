 ...
 <!-- total count -->
 <div class="w-1/2 md:w-1/3 my-4 px-2.5 py-1.5 bg-gray-100 border text-sm border-gray-300 rounded-md tracking-wider font-medium capitalize text-center ">
     <div class="table-header-count hidden">

     </div>
     <div class="total-group">
         <span class="total-txt text-base text-gray-700">Total Groups : </span>
         <span class="total-inst-count tracking-widest text-blue-700 text-lg">
             <!-- spinner -->
