 ...
 <!-- total count -->
 <div class="table-header-count my-4 p-2.5 bg-purple-100 rounded-md tracking-wider font-medium capitalize text-center ">
     total groups : <span class="total-inst-count tracking-widest text-blue-800 text-lg">
        <!-- spinner -->
