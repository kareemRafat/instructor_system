    ...
    <div class="flex flex-col items-center justify-center md:my-8 text">
        <div class="w-full max-w-full md:max-w-md bg-white rounded-lg md:shadow-md p-6">
            ...
            <form action="functions/Lectures/insert_lecture.php" method="POST" class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row items-start flex-wrap gap-4 mb-6">
                    <div class="flex items-center gap-2 bg-amber-50 px-4 py-2 rounded-lg border border-amber-200 w-full md:w-48 shadow-sm">
                    ...
                    <div class="flex items-center gap-2 bg-teal-50 px-4 py-2 rounded-lg border border-teal-200 w-full md:w-48 shadow-sm">
